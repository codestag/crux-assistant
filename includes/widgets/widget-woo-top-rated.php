...
add_action(
	'widgets_init',
	function() {
		return register_widget( 'stag_widget_top_rated_products' );
	}
);
...
class stag_widget_top_rated_products extends WP_Widget {
	function __construct() {
		$widget_ops  = array(
			'classname'   => 'widget-top-rated-products',
			'description' => __( 'Display a list of top rated products on your site.', 'crux-assistant' ),
		);
		$control_ops = array(
			'width'   => 300,
			'height'  => 350,
			'id_base' => 'stag_widget_top_rated_products',
		);
		parent::__construct( 'stag_widget_top_rated_products', __( 'Section: Custom Top Rated Products', 'crux-assistant' ), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		$defaults = array(
			...
			'title' => __( 'Top Rated Products', 'crux-assistant' ),
			'count' => 4,
		);
